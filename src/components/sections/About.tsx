  ...
  return (
    ...
    >
      <div className="max-w-5xl mx-auto px-4">
        <h2 className="pb-4 text-3xl font-bold bg-gradient-to-r from-blue-500 to-cyan-400 bg-clip-text text-transparent text-center">
          About Me
        </h2>
